        ...
        <template v-slot:header>
            <div class="flex items-center justify-between">
                <h1
                    ...
                    {{ model.id ? model.title : "Create a Review" }}
                </h1>
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" v-model="model.title" auto-complete="review_title"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea name="description" id="description" v-model="model.description"
                                autocomplete="review_description" placeholder="Describe your Review."
...
if (route.params.id) {
    model.value = store.state.reviews.find(
...
function saveReview() {
    store.dispatch("saveReview", model.value).then(({data}) => {
        router.push({
            name: "ReviewView",
